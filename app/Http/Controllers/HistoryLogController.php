...
class HistoryLogController extends Controller
{
    ...
    {
        // Tentukan path direktori dengan benar
        $directory = public_path('storage'); // Gantilah 'storage/storage' menjadi 'storage'

        // Periksa apakah direktori ada
        if (!File::exists($directory)) {
            return 'storage/default-profile.jpg'; // Jika direktori tidak ada, kembalikan foto default
        }
        ...
        if ($mostRecentFile) {
            return 'storage/' . basename($mostRecentFile);
        }
